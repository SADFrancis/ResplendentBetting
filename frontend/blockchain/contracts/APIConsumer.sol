...
contract APIConsumer is ChainlinkClient {
    ...
    constructor() {
        ...
        oracle = 0xF405B99ACa8578B9eb989ee2b69D518aaDb90c1F; // LinkRiver Kovan
        jobId = "7c4b968028f74b2eabd7d428f03ba45c"; //HTTPGET > Bytes32!!!
    ...
    function requestData(address callBackContract, bytes4 functionSelector) public returns (bytes32 requestId) 
    {
        ...
        request.add("get", "https://feh-resplendent-api.herokuapp.com/resplendents/latest");
